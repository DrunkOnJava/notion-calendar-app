...
async function globalSetup() {
  ...
  try {
    ...
    if (useContainers) {
      ...
      process.env.TEST_MINIO_ACCESS_KEY = process.env.TEST_MINIO_ACCESS_KEY || 'test_minio_user'
      process.env.TEST_MINIO_SECRET_KEY = process.env.TEST_MINIO_SECRET_KEY || 'test_minio_pass_123'
    }
