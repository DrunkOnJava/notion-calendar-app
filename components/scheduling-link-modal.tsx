  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-card border-border max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg border">
        ...
        <div className="space-y-6 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="bg-input border-border text-foreground placeholder-muted-foreground focus:ring-info w-full rounded-lg border px-3 py-2 focus:border-transparent focus:ring-2 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="bg-input border-border text-foreground placeholder-muted-foreground focus:ring-info w-full resize-none rounded-lg border px-3 py-2 focus:border-transparent focus:ring-2 focus:outline-none"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="text-muted-foreground mb-2 block text-sm">Duration (min)</label>
                <select
                  value={duration}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-foreground text-sm font-medium">Require Approval</div>
                <div className="text-muted-foreground text-xs">
                  Manually approve booking requests
                </div>
              </div>
              <button
            ...
            <div>
              <label className="text-muted-foreground mb-2 block text-sm">Event Color</label>
          ...
          {name && (
            <div className="space-y-2">
              <label className="text-foreground block text-sm font-medium">Your Booking Link</label>
              <div className="flex items-center gap-2">
                <input
                  type="text"
                  value={generatedLink}
                  readOnly
                  className="bg-surface border-border text-secondary flex-1 rounded-lg border px-3 py-2 text-sm focus:outline-none"
                />
                <Button
                  onClick={copyLink}
                  variant="outline"
        ...
        <div className="bg-card border-border sticky bottom-0 flex justify-end gap-2 border-t p-4">
