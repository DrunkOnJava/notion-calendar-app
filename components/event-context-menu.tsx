...
export function EventContextMenu({
  ...
  return (
    <div
      className="fixed z-50 min-w-[220px] rounded-lg border border-[#2a2a2a] bg-[#1c1c1c] py-1 shadow-xl"
      style={{
    ...
    >
      <div className="border-b border-[#2a2a2a] px-3 py-2 text-xs text-[#6b6b6b]">
        {event.title}
      </div>
      ...
      <div className="py-1">
        <button
          ...
          className="flex w-full items-center gap-3 px-3 py-2 text-sm text-[#d0d0d0] transition-colors hover:bg-[#2a2a2a]"
        >
        ...
        <div className="relative">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2 text-sm text-[#d0d0d0] transition-colors hover:bg-[#2a2a2a]"
          >
            <Palette className="h-4 w-4 text-[#6b6b6b]" />
          ...
          {showColorPicker && (
            <div
              className="absolute top-0 left-full ml-1 min-w-[160px] rounded-lg border border-[#2a2a2a] bg-[#1c1c1c] p-2 shadow-xl"
              onClick={(e) => e.stopPropagation()}
            >
              ...
              <button
                ...
                className="mt-2 w-full rounded px-2 py-1.5 text-xs text-[#9a9a9a] transition-colors hover:bg-[#2a2a2a] hover:text-white"
              >
                Reset to default
              </button>
            </div>
        ...
        <div className="relative">
          ...
          {showCalendarPicker && (
            <div
              className="absolute top-0 left-full ml-1 min-w-[180px] rounded-lg border border-[#2a2a2a] bg-[#1c1c1c] py-1 shadow-xl"
              onClick={(e) => e.stopPropagation()}
            >
              {['Personal', 'Work', 'Family', 'Holidays'].map((calendar) => (
                <button
                  ...
                  className="flex w-full items-center gap-2 px-3 py-2 text-sm text-[#d0d0d0] transition-colors hover:bg-[#2a2a2a]"
                >
                  <div
                    className={cn(
